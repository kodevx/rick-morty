...
export default function CardsShimmer () {
    return (
        <>
            ...
            <div className="h-72 w-200 p-11 flex flex-row shadow-xl animate-pulse rounded-2xl">
                ...
                <div className="flex-grow self-center ml-10">
                    <div className="pb-3 flex flex-row items-center">
                        <div className="h-3 w-18 bg-gray-200 rounded-2xl mr-2" /> <div className="h-3 w-60 bg-gray-200 rounded-2xl mr-2" />
                    </div>
                    <div className="pb-3 flex flex-row items-center">
                        <div className="h-3 w-18 bg-gray-200 rounded-2xl mr-2" /> <div className="h-3 w-60 bg-gray-200 rounded-2xl mr-2" />
                    </div>
            ...
            <div className="h-72 w-200 p-11 flex flex-row shadow-xl animate-pulse rounded-2xl">
                <div className="flex self-center h-52 w-64 bg-gray-200 rounded-4xl" />
                <div className="flex-grow self-center ml-10">
                    <div className="pb-3 flex flex-row items-center">
                        <div className="h-3 w-18 bg-gray-200 rounded-2xl mr-2" /> <div className="h-3 w-60 bg-gray-200 rounded-2xl mr-2" />
                    </div>
